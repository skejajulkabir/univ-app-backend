...
const getProductController = async (req,res)=>{
    try {
        if(req.query.page && req.query.limit){
            ...
            let paginatedProducts = await Product.find().skip(skip).limit(limit);
...
const getPostController = async (req,res)=>{
    try {
        if(req.query.page && req.query.limit){
            ...
            let paginatedPosts = await Post.find().skip(skip).limit(limit);
...
module.exports = {getProductController , findproductbyidController , createPostController , getPostController , getRightSidebarUserListController};